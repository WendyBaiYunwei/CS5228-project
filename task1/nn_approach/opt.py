...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--load',           type=str, default='/home/kaiwang/cs5228/checkpoint/test/ckpt_best.pth.tar', help='path to load a pretrained checkpoint')
        ...
        self.parser.add_argument('--linear_size',    type=int, default=1536, help='size of each model layer')
        ...
        self.parser.add_argument('--lr_decay',       type=int,    default=900, help='# steps of lr decay')
        self.parser.add_argument('--lr_gamma',       type=float,  default=0.6)
